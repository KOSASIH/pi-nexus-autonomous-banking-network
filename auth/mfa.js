...
router.post('/mfa/verify', async (req, res) => {
  ...
  switch (mfaMethod) {
    case 'otp':
      ...
      break;
    case 'authenticator':
      const authenticatorToken = speakeasy.totp.verify(verificationCode, user.mfa.authenticator.secret);
      ...
      break;
    case 'smartCard':
      const smartCardVerified = await smartCardAuth.verifyToken(user, verificationCode);
