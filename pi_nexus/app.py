from controllers.account_controller import deposit, transfer, withdraw
...
def deposit_route():
    ...
    transaction_history = render_transaction_history(
        transaction_service.get_transactions(account_number)
    )
    return jsonify(
        {"account_balance": account_balance, "transaction_history": transaction_history}
    )
...
def transfer_route():
    ...
    from_transaction_history = render_transaction_history(
        transaction_service.get_transactions(from_account_number)
    )
    to_transaction_history = render_transaction_history(
        transaction_service.get_transactions(to_account_number)
    )
    return jsonify(
        {
            "from_account_balance": from_account_balance,
            "to_account_balance": to_account_balance,
            "from_transaction_history": from_transaction_history,
            "to_transaction_history": to_transaction_history,
        }
    )
