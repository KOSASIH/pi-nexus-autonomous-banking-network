// File: DecentralizedExchange.sol
...
contract DecentralizedExchange {
    ...
    /**
     * @dev Represents an order on the decentralized order book
     */
    struct Order {
        uint256 amount;
        uint256 price;
    ...
    /**
     * @dev Places a new order on the decentralized order book
    ...
    /**
     * @dev Fills an order on the decentralized order book
    ...
    /**
     * @dev Cancels an order on the decentralized order book
