...
class TicketSystem:
    ...
    def get_pi_coin_balance(self, user_id):
        ...
        headers = {"API-KEY": PI_COIN_API_KEY, "API-SECRET": PI_COIN_API_SECRET}
        response = requests.get(
            f"https://api.pi-coin.com/v1/users/{user_id}/balance", headers=headers
        )
    ...
    def pay_ticket(self, ticket_id, user_id):
        ...
        response = requests.post(
            f"https://api.pi-coin.com/v1/payments",
            headers=headers,
            json={
