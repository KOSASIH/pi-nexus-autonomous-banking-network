...
class SmartContractInteraction:
    def __init__(self, blockchain_interface, contract_address, abi):
        ...
        self.contract = self.blockchain_interface.web3.eth.contract(address=contract_address, abi=abi)
    ...
    def send_transaction_to_contract(self, function_name, *args, transaction_value=0):
        return self.contract.functions[function_name](*args).transact({'value': transaction_value})
