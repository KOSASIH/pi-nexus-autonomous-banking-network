...
class SmartContractManager:
    def __init__(self, web3_provider_url: str, contract_address: str, contract_abi: str):
    ...
    def deploy_contract(self, contract_bytecode: str, constructor_arguments: List[str]) -> str:
        ...
        signed_tx = self.web3.eth.account.signTransaction(tx_data, private_key=self.web3.eth.defaultAccount.privateKey.key)
    ...
    def call_contract_method(self, method_name: str, method_arguments: List[str]) -> str:
...
if __name__ == "__main__":
    ...
    smart_contract_manager = SmartContractManager(web3_provider_url, contract_address, contract_abi)
