...
import "https://github.com/aave/protocol-v2/contracts/protocol/lendingpool/LendingPool.sol";
...
contract PiCycle {
    ...
    uint256 public constant LENDING_POOL_UPDATE_INTERVAL = 24 hours;
    ...
    uint256 public lendingPoolInterestRate;
    ...
    constructor() public {
        ...
        lendingPoolAddress = address(new LendingPool());
    ...
    function updateLendingPool() public {
        require(msg.sender == lendingPoolAddress, "Only the lending pool can update the interest rate");
        uint256 newInterestRate = LendingPool(lendingPoolAddress).getInterestRate();
        require(newInterestRate > 0, "Invalid interest rate update");
        lendingPoolInterestRate = newInterestRate;
        emit LendingPoolUpdated(lendingPoolAddress);
    }
    ...
    contract Oracle {
        ...
        function getPrice(uint256 randomness) public returns (uint256) {
            // Implement your custom pricecalculation logic here
