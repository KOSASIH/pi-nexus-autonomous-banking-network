...
class MetaMaskAdapter:
    ...
    def create_payment(self, recipient_address, amount, payment_identifier, user_uid):
        ...
        payment_response = self.wallet_connector.create_payment(
            recipient_address, amount, payment_identifier, user_uid
        )
    ...
    def complete_payment(self, payment_identifier, txid):
        ...
        complete_response = self.wallet_connector.complete_payment(
