  ...
  return (
    <div className="Dashboard">
        ...
        <ul>
          {governanceProposals.map((proposal, index) => (
            <li key={index}>
              ...
              <button onClick={() => voteOnGovernanceProposal(index, true)}>
                Approve
              </button>
              <button onClick={() => voteOnGovernanceProposal(index, false)}>
                Reject
              </button>
            </li>
          ))}
      ...
      <div className="Liquidity">
        ...
        <button onClick={() => addLiquidity(100000000000000000)}>
          Add Liquidity
        </button>
      </div>
        ...
        <ul>
          {borrowingRequests.map((request, index) => (
            <li key={index}>
              ...
              <button onClick={() => approveBorrowingRequest(index)}>
                Approve
              </button>
            </li>
          ))}
        </ul>
        <button onClick={() => requestBorrowing(100000000000000000)}>
          Request Borrowing
        </button>
      </div>
      <div className="Chart">
