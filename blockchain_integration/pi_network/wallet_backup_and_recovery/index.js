...
const walletBackupAndRecovery = new WalletBackupAndRecovery('0xWALLET_BACKUP_AND_RECOVERY_CONTRACT_ADDRESS', web3);
const walletBackupAndRecoveryController = new WalletBackupAndRecoveryController(walletBackupAndRecovery, wallet);
