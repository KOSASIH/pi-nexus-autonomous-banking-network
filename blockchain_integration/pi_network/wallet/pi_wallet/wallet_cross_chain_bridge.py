...
class CrossChainBridge:
    ...
    def send_transaction(self, transaction):
        ...
        while True:
            main_chain_status_response = requests.get(self.main_chain_url + '/' + main_chain_tx_hash)
    ...
    def verify_transaction(self, tx_hash, chain_url):
        ...
        if self.verify_signature(transaction['sender'], transaction['signature'], transaction):
            return True
        else:
            return False
...
if __name__ == '__main__':
    ...
    main_chain_tx_hash, side_chain_tx_hash = cross_chain_bridge.send_transaction(transaction)
