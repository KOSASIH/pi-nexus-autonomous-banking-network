...
class BackupAndRecovery:
    ...
    def create_backup(self):
        ...
        backup_file_path = os.path.join(self.wallet_data["backup_dir"], "wallet_backup.json")
...
if __name__ == '__main__':
    ...
    backup_and_recovery = BackupAndRecovery(wallet_data, "private_key.pem", "public_key.pem", encryption_key)
