    ...
    def schedule_transaction(self, transaction_details):
        try:
            ...
            job = self.scheduler.add_job(
                ...
                args=[tx_id, recipient_address, amount, currency],
            )
...
# Example usage
advanced_transaction_scheduling = AdvancedTransactionScheduling(
    "bitcoin", "1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", "ainnet"
)
...
job_id = advanced_transaction_scheduling.schedule_recurring_transaction(
    transaction_details
)
print("Job ID:", job_id)
...
workflow_id = advanced_transaction_scheduling.create_complex_transaction_workflow(
    workflow_details
)
