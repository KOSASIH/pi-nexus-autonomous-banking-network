...
class OffChain:
    ...
    def get_weather(self, city: str) -> Dict[str, Any]:
        ...
        params = {"q": city, "appid": self.api_keys["weather_api"], "units": "metric"}
    ...
    def send_transaction(
        self, to: str, value: float, gas_price: float, gas_limit: int, nonce: int
    ) -> str:
        """
        Send a transaction.
        """
        ...
        signed_transaction = web3.eth.account.signTransaction(
            transaction, private_key=self.api_keys["ethereum_private_key"]
        )
