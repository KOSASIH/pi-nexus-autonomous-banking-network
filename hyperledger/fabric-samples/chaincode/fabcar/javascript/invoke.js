...
async function main() {
    try {
        ...
        const carOwner = 'Tom';
        await contract.submitTransaction('CreateCar', carNumber, carColour, carMake, carModel, carOwner);
        console.log(`Created car ${carNumber} with colour ${carColour}, make ${carMake} and model ${carModel} for owner ${carOwner}`);
