...
class TransformerAttentionExplainableRiskManager:
    def __init__(self, input_dim, hidden_dim, output_dim):
        super(TransformerAttentionExplainableRiskManager, self).__init__()
...
model = TransformerAttentionExplainableRiskManager(input_dim=data.shape[1], hidden_dim=128, output_dim=1)
