  ...
  <div>
    ...
    <svg width="800" height="600">
      <g v-for="node in nodes" :key="node.node_id">
        ...
        <text :x="node.x" :y="node.y" text-anchor="middle">{{ node.node_id }}</text>
      </g>
      <g v-for="edge in edges" :key="edge.edge_id">
        <line :x1="edge.node1.x" :y1="edge.node1.y" :x2="edge.node2.x" :y2="edge.node2.y" stroke="black" stroke-width="2" />
      </g>
    </svg>
  </div>
</template>
