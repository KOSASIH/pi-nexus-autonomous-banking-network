...
int main() {
    ...
    xrCreateReferenceFrame(session, XR_REFERENCE_FRAME_TYPE_STAGE, &referenceFrame);

    // Create a graphics binding
    XrGraphicsBinding graphicsBinding;
    xrCreateGraphicsBinding(session, XR_GRAPHICS_BINDING_TYPE_VULKAN, &graphicsBinding);
