...
class GraphNeuralNetworkAnomalyDetector(torch.nn.Module):
    def __init__(self, num_features, hidden_dim, output_dim):
        super(GraphNeuralNetworkAnomalyDetector, self).__init__()
...
model = GraphNeuralNetworkAnomalyDetector(num_features=data.shape[1], hidden_dim=128, output_dim=1)
