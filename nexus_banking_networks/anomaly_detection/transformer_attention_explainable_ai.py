...
class TransformerAttentionExplainableAnomalyDetector(torch.nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        super(TransformerAttentionExplainableAnomalyDetector, self).__init__()
...
model = TransformerAttentionExplainableAnomalyDetector(input_dim=data.shape[1], hidden_dim=128, output_dim=1)
