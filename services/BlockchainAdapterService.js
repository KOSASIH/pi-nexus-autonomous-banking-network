...
class BlockchainAdapterService {
    ...
    async transferToBitcoin(piAddress, bitcoinAddress, amount) {
        ...
        const transaction = this.bitcoinService.createTransaction(bitcoinAddress, bitcoinAmount);
    ...
    async transferToLitecoin(piAddress, litecoinAddress, amount) {
        ...
        const transaction = this.litecoinService.createTransaction(litecoinAddress, litecoinAmount);
