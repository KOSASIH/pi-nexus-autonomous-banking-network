...
const wallet = await DirectSecp256k1HdWallet.fromMnemonic('your-mnemonic-phrase');
...
const sendIbcTransfer = async (sourcePort, sourceChannel, destinationPort, destinationChannel, amount, sender) => {
  const transferMsg = {
...
sendIbcTransfer(sourcePort, sourceChannel, destinationPort, destinationChannel, amount, sender);
