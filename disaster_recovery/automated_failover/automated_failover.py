...
recovery_services_client = recoveryservices.RecoveryServicesClient(
...
while (
    failover_result.properties.failover_operation_status
    != recoverymodels.FailoverOperationStatus.succeeded
):
    time.sleep(10)
...
while (
    failback_result.properties.failover_operation_status
    != recoverymodels.FailoverOperationStatus.succeeded
):
    time.sleep(10)
