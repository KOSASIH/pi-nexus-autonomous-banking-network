...
class MicrotransactionHandler:
    ...
    def authenticate_client(self, client_socket):
        ...
        if encrypted_client_secret == cipher_suite.encrypt(b'microtransaction_client_secret'):
            return True
        else:
            return False
...
if __name__ == '__main__':
    ...
    microtransaction_handler = MicrotransactionHandler(bank_account, microtransaction_secret)
