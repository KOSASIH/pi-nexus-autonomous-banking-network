...
describe('MultiChainExchange', function () {
  ...
  beforeEach(async function () {
    ...
    multiChainExchange = await MultiChainExchange.deploy(multiChainToken.address, multiChainOracle.address);
  });

  describe('deployment', function () {
    it('should set the right token and oracle addresses', async function () {
      expect(await multiChainExchange.token()).to.equal(multiChainToken.address);
      expect(await multiChainExchange.oracle()).to.equal(multiChainOracle.address);
    });
  });
