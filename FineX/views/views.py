...
class TransactionListCreateView(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        """
        account_from = get_object_or_404(Account, account_number=self.request.data['account_from'])
        account_to = get_object_or_404(Account, account_number=self.request.data['account_to'])
