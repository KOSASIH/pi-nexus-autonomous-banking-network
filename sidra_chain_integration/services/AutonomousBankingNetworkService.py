class AutonomousBankingNetworkService:
    def __init__(self, autonomous_banking_network_model: AutonomousBankingNetworkModel) -> None:
    ...
    def get_account_balance(self, account_address: str) -> int:
        ...
        return self.autonomous_banking_network_model.get_account_balance(account_address)
