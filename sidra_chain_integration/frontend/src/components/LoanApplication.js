  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        onChange={(event) =>
          setApplication({ ...application, creditScore: event.target.value })
        }
      />
      <br />
      <label>Income:</label>
      <input
        ...
        onChange={(event) =>
          setApplication({ ...application, income: event.target.value })
        }
      />
      <br />
      ...
      <input
        type="number"
        value={application.employmentHistory}
        onChange={(event) =>
          setApplication({
            ...application,
            employmentHistory: event.target.value,
          })
        }
      />
      <br />
      ...
      <input
        ...
        onChange={(event) =>
          setApplication({ ...application, loanAmount: event.target.value })
        }
      />
      <br />
