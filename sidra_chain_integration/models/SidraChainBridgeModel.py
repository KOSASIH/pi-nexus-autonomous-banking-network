@dataclass
class SidraChainBridgeModel:
    node_url: str
    api_key: str
    contract_address: str

    def transfer_funds(self, recipient: str, amount: int) -> None:
        # Call the Sidra Chain Bridge's transferFunds function using the contract address and API key
    ...
    def get_account_balance(self, account_address: str) -> int:
        # Query the Sidra Chain Bridge's account balance using the contract address and API key
