        ...
        while True:
            ...
            if choice == 1:
                ...
                for account in accounts:
                    print(
                        f"ID: {account['id']}, Name: {account['name']}, Balance: {account['balance']}"
                    )
            elif choice == 2:
                ...
                for transaction in transactions:
                    print(
                        f"ID: {transaction['id']}, Date: {transaction['date']}, Amount: {transaction['amount']}"
                    )
            elif choice == 3:
                ...
                result = bank_api_obj.transfer_funds(
