...
class TestBankOfAmerica(unittest.TestCase):
    ...
    def test_get_account_info_failure(self, mock_get):
        ...
        mock_get.return_value.json.return_value = {"error": "Account not found"}
    ...
    def test_make_transaction_success(self, mock_post):
        ...
        mock_post.return_value.json.return_value = {"transaction_id": "abcdefg12345"}

        transaction_id = self.bank_of_america.make_transaction(
            "1234567890", 100.00, "0987654321"
        )
    ...
    def test_make_transaction_failure(self, mock_post):
        ...
        mock_post.return_value.json.return_value = {"error": "Invalid transaction"}
    ...
    def test_make_transaction_fraud_detected(self, mock_post):
        ...
        mock_post.return_value.json.return_value = {"error": "Fraud detected"}
    ...
    def test_predict_fraud_maintenance(self, mock_get):
        mock_get.return_value.status_code = 500
        mock_get.return_value.json.return_value = {"error": "Maintenance in progress"}
    ...
    def test_predict_fraud_custom_url(self, mock_get_api_url):
        ...
        self.assertEqual(
            mock_get.call_args[0][0], "https://custom-api-url.com/predict_fraud"
        )
        self.assertEqual(
            mock_get.call_args[1]["headers"], {"Authorization": "Bearer test_api_key"}
        )
        self.assertEqual(
            mock_get.call_args[1]["json"],
            [
                {
                    "transaction_id": "abcdefg12345",
                    "amount": 100.00,
    ...
    def test_predict_fraud_custom_headers(self, mock_get_api_url):
        ...
        self.assertEqual(
            ...
            {"Authorization": "Bearer test_api_key", "X-Custom-Header": "value"},
        )
        self.assertEqual(
            mock_get.call_args[1]["json"],
            [
    ...
    def test_predict_fraud_api_error(self, mock_get_api_url):
        ...
        mock_get.return_value.status_code = 500
        mock_get.return_value.json.return_value = {"error": "API error"}
    ...
    def test_predict_fraud_no_error_response(self, mock_get_api_url):
        ...
        mock_get.return_value.status_code = 400
        mock_get.return_value.json.return_value = {
            "transactions": [{"transaction_id": "abcdefg12345", "fraud_score": 0.8}]
        }
